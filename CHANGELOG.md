...
- docs: the installation page and the PyPI project page say `pip install mathspec`, and the README's links resolve on PyPI ([#PR](https://github.com/energy-models/mathspec/pull/PR))
