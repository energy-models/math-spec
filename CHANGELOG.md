...
- refactor(language): a term of a sum is an ordinary named expression, and only `merge` holds it to the rules of the sum ([#734](https://github.com/energy-models/mathspec/pull/734))
