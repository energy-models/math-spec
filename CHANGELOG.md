...
- feat(language): two files that state the same spec write one text, and `canonical --check` fails a file that is not in it ([#PR](https://github.com/energy-models/mathspec/pull/PR))
