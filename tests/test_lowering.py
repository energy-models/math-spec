...
def test_a_parameter_covers_every_coordinate_unless_it_says_otherwise():
    ...
    missing row was meant, and which of the two a declaration means survives lowering, because whatever attaches the
...
def test_a_parameter_a_curve_owns_answers_for_no_coverage():
    ...
    curve runs. The refusal is a fact about the file, and whatever attaches the table reads the program: reporting
