...
class _Resolver:
    ...
    def _relation_ref(
        ...
        """An operator's ``by=``, with the ``over=`` and ``into=`` that say which direction it is read in.
    ...
    def _direction(
        ...
        if not forward and not direction.is_single_valued:
            self.errors.append(
            ...
            return None
        if forward and direction.is_single_valued:
            self.errors.append(
