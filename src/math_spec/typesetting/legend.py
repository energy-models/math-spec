...
from math_spec.typesetting.format import Entry

if TYPE_CHECKING:
    from collections.abc import Iterable

    from math_spec.program import Expression, Mask, Program, RelationDeclaration
    from math_spec.typesetting.format import Format, OperatorName
