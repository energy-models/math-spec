...
OPERATORS = {
    ...
    'sum(array, over=relation.a)': 'sum_by',
    'sum(array, over=relation.a), joining on the rest of the key': 'sum_by_columns',
    'sum(array, by=relation.[b, …])': 'sum_by_column_lists',
    ...
    'shift(array, along=relation.a, offset=n, within=c)': 'shift_partitioned',
    ...
    'sum_back(array, along=relation.a, window=n, within=c)': 'sum_back_partitioned',
