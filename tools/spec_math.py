...
OPERATORS = {
    ...
    'sum(array, by=relation(a -> b))': 'sum_by',
    'sum(array, by=relation(a -> b)), joining on the rest of the key': 'sum_by_columns',
    'sum(array, by=relation([a, …] -> [b, …]))': 'sum_by_column_lists',
    ...
    'shift(array, along=dim, offset=n, by=relation(c))': 'shift_partitioned',
    ...
    'sum_back(array, along=dim, window=n, by=relation(c))': 'sum_back_partitioned',
