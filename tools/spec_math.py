...
OPERATORS = {
    ...
    'sum(array, over=relation.a, by=relation.b)': 'sum_by_columns',
    'sum(array, over=relation.[a, …], by=relation.[b, …])': 'sum_by_column_lists',
    'at(array, by=relation)': 'at',
    'at(array, by=relation.a)': 'at_columns',
    ...
    'shift(array, along=relation.k, offset=n)': 'shift_partitioned',
    ...
    'sum_back(array, along=relation.k, window=n)': 'sum_back_partitioned',
