...
OPERATORS = {
    ...
    'sum(array, over=relation.k)': 'sum_over_key',
    'sum(array, by=relation.v)': 'sum_by',
    'sum(array, by=[relation, …])': 'sum_by_relations',
    'sum(array, by=relation.[b, …])': 'sum_by_column_lists',
    'array[relation]': 'index',
    'array[relation.v]': 'index_columns',
    ...
    'shift(array, along=relation.d, offset=n)': 'shift_partitioned',
    ...
    'sum_back(array, along=relation.d, window=n)': 'sum_back_partitioned',
