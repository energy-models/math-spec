...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7182.222222222223`, 45 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `4456.659315422356`, 103 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7633.908502024292`, 184 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `8785.0`, 64 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `10282.833333333334`, 102 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `23962.0`, 123 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7775.0`, 116 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `19712.5`, 155 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `11700.0`, 68 rows. `lpspec 0.0.1.dev2+ge30be475d` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
