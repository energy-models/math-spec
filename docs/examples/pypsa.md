...
What is **proven** is a per-rung fact, and each rung's reference banner
below states its own: every rung solves to PyPSA's objective on generic
data (`parity.py`, both lanes through HiGHS); a rung whose two linopy
models — PyPSA's and `lpspec.linopy`'s — compare equal label for label is
**proven model-for-model**, the strongest claim this page makes; a rung
whose file the linopy lane cannot build yet says so, its blocker stamped in
`references.json`, and its proof stops at the objective until lpspec
hardens.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7182.222222222223`, 45 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 8 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `4456.659315422356`, 103 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 8 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7633.908502024292`, 184 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 12 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `8785.0`, 64 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 12 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `10282.833333333334`, 102 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 8 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `23962.0`, 123 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 20 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `7775.0`, 116 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `19712.5`, 155 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate).
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `11700.0`, 68 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 20 rows.
...
> ✔ `pypsa 1.3.0` solves this rung's reference network at objective `-3474256.0405499246`, 468 rows. `lpspec ga6a817698` binds `examples/pypsa.yaml` against the same network and lands on the same objective (lpspec's parity gate). Nodal prices agree on 90 rows.
