...
| 4   | Where a name may stand depends on what it is. A dimension follows `over=` or `along=`, a relation's column follows either after a dot, and neither is ever multiplied. | [Names](expressions.md#name-resolution)                         |
