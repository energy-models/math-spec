...
|                                                                         |                                                                                                               |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [File shape](file.md)                                                   | the eleven keys, `version`, `description`, and how the YAML is read                                           |
...
| [Given declarations](given.md)                                          | the variables and constraints a file reads and does not introduce                                             |
