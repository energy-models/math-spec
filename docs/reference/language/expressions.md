...
| `position(name, by=lookup) OP i`     | a dimension and a lookup keyed over it | the same, counted **within each group** the lookup's value columns make — every period's first snapshot, whatever each period's length                                                                                                                                                                                                                                                                                                                                      |
