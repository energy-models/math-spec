...
| `name` (bare)                              | lookup                                 | a row exists: at the key for a keyed lookup, at every column for a bare relation. A lookup may be [partial](dimensions.md#lookups), and this is how a declaration asks for the labels that do map                                                                                                                                                                                                                                                                           |
