...
| `position(name, by=relation[(c)])`   | a dimension and a relation keyed over it | The same, counted within each group the relation's value columns make, or the columns `c` names                                                                                                                                                                                                     |
