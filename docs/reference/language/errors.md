...
| Not here                                                                       | Instead                                                                                                                                                         |
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| variable × variable in a **bound, a named expression or a `piecewise:` link**  | the objective and constraints take it; elsewhere, a parameter coefficient ([expressions](expressions.md#quadratic-expressions))                                 |
...
| `**`                                                                           | `x * x` ([expressions](expressions.md#quadratic-expressions))                                                                                                   |
